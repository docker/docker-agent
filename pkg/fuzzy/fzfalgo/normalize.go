// Extracted from github.com/junegunn/fzf v0.74.4 src/algo/normalize.go (MIT,
// Copyright (c) 2013-2026 Junegunn Choi). See ../README.md. Only the package
// clause changed and the unused NormalizeRunes helper was dropped.
