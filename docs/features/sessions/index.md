...
workspace file was edited, moved, or deleted. If the portable-copy write
fails, the workspace file is kept and the turn carries a warning. Ordinary follow-up turns replace
