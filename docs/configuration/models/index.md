...
so those models remain eligible as title candidates. Google image-output
requests that include tools or structured output are rejected locally. For a
custom-tool conflict, models.dev's `tool_call` capability makes the error say
